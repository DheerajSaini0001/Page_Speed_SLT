 ...
 hover:scale-105 transition-transform duration-300">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm">
          <div className="flex justify-between items-center">
            ...
            <ScoreBadge score={data.jsonData?.A?.A3?.Correct_Schema_Types_Score.toFixed(1) ?? 0} />
          </div>
          <div className="flex justify-between items-center">
            <span>Feed Availability Score</span>
            <ScoreBadge score={data.jsonData?.A?.A3?.Feed_Availability_Score.toFixed(1) ?? 0} />
          </div>
        </div>
      </div>
      {/* Crawlability & Hygiene */}
 ...
 hover:scale-105 transition-transform duration-300">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm">
          <div className="flex justify-between items-center">
            ...
            <ScoreBadge score={data.jsonData?.A?.A3?.Robots_Allowlist_Score.toFixed(1) ?? 0} />
          </div>
        </div>
      </div>
    </div>
